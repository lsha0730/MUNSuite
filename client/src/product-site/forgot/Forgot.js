    ...
    return (
        <div className="centering-container">
            ...
            <div className="forgot-container">
                ...
                <input type="text" id="email" className="input-field" onKeyDown={(e) => {if (e.key === 'Enter') handleForgot()}}></input>

                <div className="btt-container">
                    <div className="btt-send" onClick={handleForgot}>Send Email</div>
