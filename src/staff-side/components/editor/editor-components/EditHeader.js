...
function EditHeader(props) {
    ...
    const [imageData, setImageData] = useState({imgLink: props.imgLink, imgName: props.imgName, imgPath: props.imgPath});
    ...
    return (
        <div className={props.editing==props.id? "block-container":"hidden"}>
            ...
            <input type="text" placeholder="Input here..." className="textfield-container" defaultValue={props.heading? props.heading:""} onChange={e => {setHeading(e.target.value)}}></input>

            <p className="subheading">Subheading</p>
            <input type="text" placeholder="Input here..." className="textfield-container" defaultValue={props.subheading? props.subheading:""} onChange={e => {setSubheading(e.target.value)}}></input>
